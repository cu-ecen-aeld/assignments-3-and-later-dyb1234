...
SYS_TOOLCHAINS=$(${CROSS_COMPILE}gcc -print-sysroot)
...
cp ${SYS_TOOLCHAINS}/lib/ld-linux-aarch64.so.1 lib/
cp ${SYS_TOOLCHAINS}/lib64/libm.so.6 lib64/
cp ${SYS_TOOLCHAINS}/lib64/libresolv.so.2 lib64/
cp ${SYS_TOOLCHAINS}/lib64/libc.so.6 lib64/
